...
use crate::tui::bottom_pane::footer::CollaborationModeIndicator;
use crate::tui::bottom_pane::footer::FooterMode;
use crate::tui::bottom_pane::footer::GoalStatusIndicator;
