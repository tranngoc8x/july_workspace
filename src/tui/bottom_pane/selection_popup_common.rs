...
use crate::tui::support::render::RectExt as _;
use crate::tui::support::style::accent_style;
...
pub(crate) fn wrap_styled_line<'a>(line: &'a Line<'a>, width: u16) -> Vec<Line<'a>> {
    ...
    use crate::tui::support::wrapping::word_wrap_line;
...
fn wrap_two_column_row(row: &GenericDisplayRow, desc_col: usize, width: u16) -> Vec<Line<'static>> {
    use crate::tui::support::wrapping::RtOptions;
    use crate::tui::support::wrapping::word_wrap_lines;
