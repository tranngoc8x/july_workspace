...
use crate::tui::bottom_pane::selection_popup_common::menu_surface_inset;
use crate::tui::bottom_pane::selection_popup_common::menu_surface_padding_height;
use crate::tui::bottom_pane::selection_popup_common::render_menu_surface;
use crate::tui::bottom_pane::selection_popup_common::render_rows;
use crate::tui::bottom_pane::selection_popup_common::wrap_styled_line;
...
struct UnansweredConfirmationData {
    ...
    rows: Vec<crate::tui::bottom_pane::selection_popup_common::GenericDisplayRow>,
    state: ScrollState,
}
...
pub(in crate::tui::bottom_pane) fn render_rows_bottom_aligned(
    area: Rect,
    buf: &mut Buffer,
    rows: &[crate::tui::bottom_pane::selection_popup_common::GenericDisplayRow],
    state: &ScrollState,
    max_results: usize,
    empty_message: &str,
) {
...
pub(in crate::tui::bottom_pane) fn truncate_line_word_boundary_with_ellipsis(
    line: Line<'static>,
    max_width: usize,
) -> Line<'static> {
    if max_width == 0 {
