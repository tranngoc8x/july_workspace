...
use crate::tui::support::text_formatting::truncate_text;
...
impl MultiSelectPickerBuilder {
    ...
    pub fn new(title: String, subtitle: Option<String>, app_event_tx: PaneEventSender) -> Self {
        Self {
            title,
            subtitle,
    ...
    where
        F: Fn(&[MultiSelectItem], &PaneEventSender) + 'static,
    {
    ...
    where
        F: Fn(&[String], &PaneEventSender) + 'static,
    {
