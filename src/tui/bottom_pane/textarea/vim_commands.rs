...
use crate::tui::support::vim_search::SearchQuery;
...
pub(crate) struct VimPersistentState {
    ...
    search: crate::tui::support::vim_search::SearchQuery,
}
...
fn vim_command_char(event: KeyEvent) -> Option<char> {
    ...
    match event.modifiers {
        ...
        modifiers if crate::tui::support::key_hint::is_altgr(modifiers) => Some(ch),
        _ => None,
    }
}
